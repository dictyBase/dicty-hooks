...
var useIntersectionObserver = function useIntersectionObserver(_temp) {
  ...
  var observerRef = React.useRef(null); // set up callback fn that updates intersecting state
...
export { useFetch, useFetchRefreshToken, useIntersectionObserver, useVirtualList };
